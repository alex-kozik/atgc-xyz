...
#=================================================================================
# Description:
#   This python script split the SNP chunk files by the turning points 'A'<->'B', which might be mis-assembled scaffolds at SNP-groups that show a high number of differences.
#
# input arguments:
#   1.input file.
#   2. number of samples
#   3. cutoff (range: 0 < cutoff < 1):
#       may split if ratio of mismatches/matches between A and B genotype calls > cutoff, for example: 0.1
#   4. cutoffU (range: 0 < cutoffU < # of samples):
#       may split if the count of 'U' > cutoffU, for example: 25
#
# Output: splited scaffold file.
#         The newly created scaffolds will get a new unique ID name.
#
# usage:
#   python 05-ScaffoldSplit.py genotype_file number-of-example cutoff cutoffU
# example:
#   python 05-ScaffoldSplit.py genotypetable.tsv 88 0.1 10
#
######################################################################################
